...
const PostsContainer = () => {
  ...
  return (
    <div className='columns-2 md:columns-3 lg:columns-4 xl:columns-5 2xl:columns-6  sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-2xl mx-auto sm:px-10 lg:px-5 gap-4 space-y-4 mt-10'>
      {data.map((post, index) => {
        return (
          <div className='group relative' key={index} onClick={() => navigate(`/post/${post.id}`)}>
            <img className=' rounded-xl w-full bg-gray-300' src={post.img_url} alt='' />
